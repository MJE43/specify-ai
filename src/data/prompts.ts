...
export const documentPrompts: Record<DocumentType, PromptTemplate> = {
  ...
  backend: {
    ...
    userPrompt: `Based on the project requirements and description below, design a detailed backend structure:\n\n[USER_INPUT]`,
  },
  techStack: {
    ...
    userPrompt: `Based on the project requirements and tech stack below, recommend a detailed technology stack:\n\n[USER_INPUT]`,
  },
  frontend: {
